...
from .views import FamilyListView, FamilyCreateView, DailyTaskCreateView, DailyTaskDeleteView, TabsCreateView
...
urlpatterns = [
    ...
    path('create/tab', TabsCreateView.as_view(), name='tab_create'),
